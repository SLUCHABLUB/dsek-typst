// TODO: implement
// guidelines and policys are basically identical in structure
// we can probably do a common func similar to motion-proposal.typ
...
show policy.with(
  ...
  scope: [],
  history: (
    (meeting: [], who: (name1, name2), notes: [])
    (meeting: [], who: (name3), notes: [])
  )
)
*/
